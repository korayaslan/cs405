...
class MeshDrawer {
        ...
        constructor() {
                ...
                /// Lighting variables initialization
                // In your MeshDrawer constructor or appropriate method
                this.lightPosition = [5.0, 5.0, 10.0]; // Adjust as needed
                this.lightColor = [1.0, 1.0, 1.0]; // White light
                this.ambientIntensity = 0.5; // Adjust as needed

                this.lightingEnabled = false; // Lighting disabled by default

                // Get locations of the lighting-related uniform variables
        ...
        setMesh(vertPos, texCoords, normalCoords) {
                 ...
                 */
                // Update buffer for normal vectors
        ...
        draw(trans) {
                ...
                gl.uniform1f(this.ambientIntensityLoc, this.ambientIntensity);
...
const meshFS = `
    ...
    void main()
    {
        ...
        // Modify the ambient light calculation here
        vec4 ambientColor = vec4(max(ambient, 0.2), max(ambient, 0.2), max(ambient, 0.2), 1.0);
        vec3 finalColor = texColor.rgb * (ambientColor.rgb + diffuse);
...
function updateLightPos() {
        ...
        if (typeof meshDrawer !== 'undefined') {
                meshDrawer.lightPosition = [lightX, lightY, 10.0]; // Adjust the Z coordinate as needed
                ...
                console.error("meshDrawer is not defined");
            }
